    ...
    <>
      {loading ? (<ReactLoading type={"cylon"} color={"rgb(225, 41, 246)"} height={'50%'} width={'100%'} />) : (<>
        ...
        <div className="scrollmenu">
          ...
          <h5 onClick={() => { setCategory("Games") }}>Game Industry</h5>
          <h5 onClick={() => { setCategory("Music") }}>Music Industry</h5>
          <h5 onClick={() => { setCategory("Publishing") }}>Publishing</h5>
          <h5 onClick={() => { setCategory("Finance") }}>Fin Tech</h5>
          <h5 onClick={() => { setCategory("Education") }}>Edu Tech</h5>
          <h5 onClick={() => { setCategory("Eco-Friendly") }}>Agro Industry</h5>
        </div>
